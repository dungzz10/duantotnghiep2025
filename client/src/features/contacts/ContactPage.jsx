      ...
      <div className=' mx-auto bg-white rounded shadow p-6'>
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input
              className='w-[600px] border p-2 rounded'
              type="text" name="name"
          ...
          <div>
            ...
            <br />
            <button type='submit'
              className='w-[300px] bg-blue-500 text-white py-2 rounded hover:bg-blue-600'
        ...
        <footer className="mt-10 bg-white p-4 rounded-lg shadow-lg">
        <div className="mb-6">
